...
/*float matriz_s [7][5]={
{5.10,3.48,1.47,0.24,1},
{6.47,2.85,4.67,1.47,2},
{6.30,2.50,5,1.90,3},
{6.50,3,5.20,2,3},
{6.20,3.40,5.40,2.30,3},
{5.40,3,5.10,1.80,3},
{6.02,2.66,5.05,1.87,3},
};*/  // datos validos
float matriz_s[9][5]={
{5.10,3.48,1.47,0.24,1},
{5.90,2.74,4.22,1.31,2},
{6.62,2.98,5.53,2.03,3},
{6.80,2.80,4.80,1.40,2},
{6.70,3,5,1.70,2},
{5.70,2.50,5,2,3},
{6,2.20,5,1.50,3},
{5.60,2.80,4.90,2,3},
{5.20,2.80,4.80,1.80,3},
};
...
void loop() {
  ...
  */
  ...
  if (on == 0) {
    for (int i = 0; i <= 90; i++) {
      result = knn(fil_s, 5, 3, 3, matriz[i]);
